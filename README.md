...
All input variables are declared in [variables.tf](terraform/variables.tf), and their corresponding values are defined in [terraform.tfvars](terraform/terraform.tfvars). Update the `terraform.tfvars` file to customize the deployment as required.
